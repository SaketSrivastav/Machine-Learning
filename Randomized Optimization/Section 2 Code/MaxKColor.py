...
print("Random Hill Climb Kcolor Fitness Score:", best_fitness1)
print("--- %s RH training seconds ---" % (time.time() - start_time))
print("Simulated Annealing Kcolor Fitness Score:", best_fitness2)
print("--- %s SA training seconds ---" % (time.time() - start_time2))
print("Genetic Algorithm Kcolor Fitness Score:", best_fitness3)
print("--- %s GA training seconds ---" % (time.time() - start_time3))
print("MIMIC Algorithm Kcolor Fitness Score:", best_fitness4)
